  ...
  return (
    <div className='h-[40vh] md:h-[400px] lg:h-[50vh] xl:h-screen 2xl:h-[750px] w-full max-w-screen overflow-hidden bg-neutral-50 flex flex-col items-center justify-center lg:pt-[100px] md:pt-[50px]'>
      <div className='h-full w-full 3xl:w-1/2 duration-200'>
        <div className='h-full w-full flex items-center justify-center flex-col md:gap-5 gap-3 mt-5 md:mt-0'>
          <motion.div 
            className='flex items-center justify-center lg:text-[54px] md:text-[24px] 3xl:text-[62px] text-[20px] md:gap-3 gap-1'
            initial="hidden"
            animate="visible"
        ...
        <BookingModal 
          buttonClass='bg-blue-500 text-white lg:py-4 lg:px-7 md:py-3 md:px-4 py-2 px-4 rounded-full booking-section booking-left after:rounded-[10rem] md:text-[12px] lg:text-[18px] text-[14px]'
