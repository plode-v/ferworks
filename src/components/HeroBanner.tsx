    ...
    <div className='h-[40vh] md:h-[400px] lg:h-[50vh] xl:h-screen 2xl:h-[750px] w-full max-w-screen overflow-hidden bg-neutral-50 flex flex-col items-center justify-center lg:pt-[100px] md:pt-[50px]'>
      <div className='h-full w-full 3xl:w-1/2 duration-200'>
        <div className='h-full w-full flex items-center justify-center flex-col md:gap-5 gap-2'>
          <div className='flex items-center justify-center md:gap-4 gap-2 lg:text-[54px] md:text-[24px] 3xl:text-[62px] text-[20px]'>
            <h1 className='text-black/80 font-[800] md:tracking-wider'>Your safety is our</h1>
            <h1 className='bg-gradient-to-r uppercase from-cyan-400 to-blue-700 text-transparent bg-clip-text font-[900] md:tracking-wider tracking-wide'>priority.</h1>
          </div>
