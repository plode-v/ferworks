...
const Header = ({ header }: { header: string }) => {
  return (
    <div className='3xl:h-[550px] 2xl:h-[450px] lg:h-[350px] md:h-[250px] lg:mt-[100px] md:mt-[50px] mt-[80px] relative h-[150px] w-full 3xl:w-1/2 bg-neutral-100 overflow-hidden flex duration-200 justify-center items-center md:rounded-b-2xl'>
      <div className='flex items-center justify-center w-full h-full'>
          ...
          <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center'>
            <h1 className='2xl:text-[60px] lg:text-[45px] md:text-[36px] text-[24px] uppercase 2xl:font-[100] font-[100]'>{header}</h1>
          </div>
        </div>
      </div>
  )
