...
const Header = ({ header }: { header: string }) => {
  return (
    <div className='3xl:h-[550px] 2xl:h-[450px] lg:h-[400px] md:h-[300px] lg:mt-[100px] relative h-full w-full 3xl:w-1/2 bg-neutral-100 overflow-hidden flex duration-200 justify-center items-center rounded-b-2xl'>
