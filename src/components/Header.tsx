...
const Header = ({ header }: { header: string }) => {
  return (
    <div className='relative 2xl:h-[550px] h-[400px] w-full bg-neutral-100 overflow-hidden flex'>
        ...
        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center'>
          <h1 className='2xl:text-[60px] text-[45px] uppercase 2xl:font-[100] font-[200]'>{header}</h1>
        </div>
      </div>
  )
}
