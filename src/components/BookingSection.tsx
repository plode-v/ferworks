...
const BookingSection = () => {
  ...
  return (
    <div className='w-full 2xl:h-[500px] md:h-[250px] xl:h-[400px] h-[180px] bg-neutral-50 flex items-center justify-center flex-col overflow-hidden'>
      <div className='bg-neutral-800 flex md:flex-row flex-col duration-300 items-center justify-center lg:gap-10 md:gap-5 gap-3 3xl:w-1/2 w-full h-full overflow-hidden relative rounded-2xl'>
