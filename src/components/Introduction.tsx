...
const Introduction = () => {
  return (
    <div className='w-full h-[600px] bg-white flex items-center justify-center'>
        <div className='h-3/4 w-1/2 3xl:w-1/3 text-center pb-10 duration-300 flex flex-col items-center justify-center rounded-lg bg-blue-100 text-[#1a1a1a]'>
            <h1 className=' mb-4 font-[600] capitalize text-[50px]'>What we do...</h1>
