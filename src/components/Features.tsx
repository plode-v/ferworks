...
const Features = () => {
  return (
    <div className='flex w-full md:h-[350px] lg:h-[450px] bg-[#fafafa] justify-center text-white z-0'>
        <div className='md:w-full lg:w-2/3 3xl:w-1/3 h-full justify-evenly items-center flex duration-300 z-10 bg-[#fafafa]'>
